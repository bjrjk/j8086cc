...
public class SyntaxTreeHelper {
	...
	public static Symbol genTmpFatherNode(Counter cnter, Symbol s1, Symbol s2) {
		if (s2 == null)
			return new Symbol(cnter.getNewStringID(), s1.dataType, SymbolTable.TMP_VAR);
		Symbol res = new Symbol(cnter.getNewStringID(), Math.min(s1.dataType, s2.dataType), SymbolTable.TMP_VAR);
		return res;
	}

	public static Symbol genIntLiteralNode(Counter cnter) {
		Symbol res = new Symbol(cnter.getNewStringID(), Symbol.TYPE_INT, SymbolTable.TMP_VAR);
		return res;
	}
	...
	public static SymbolTable getSymbolTable(ParseTreeProperty<SymbolTable> symbolTableTree, ParserRuleContext ctx) {
		if (symbolTableTree == null || ctx == null)
			return null;
		while (ctx != null) {
			if (ctx instanceof j8086ccParser.FunctionContext) {
	...
	public static Integer getCtlBeforeLabel(ParseTreeProperty<Integer> CtlBeforeLabel, ParserRuleContext ctx) {
		if (CtlBeforeLabel == null || ctx == null)
			return null;
		while (ctx != null) {
			if (ctx instanceof j8086ccParser.WhileSyntaxContext || ctx instanceof j8086ccParser.DoWhileSyntaxContext) {
	...
	public static Integer getCtlAfterLabel(ParseTreeProperty<Integer> CtlAfterLabel, ParserRuleContext ctx) {
		if (CtlAfterLabel == null || ctx == null)
			return null;
		while (ctx != null) {
			if (ctx instanceof j8086ccParser.WhileSyntaxContext || ctx instanceof j8086ccParser.DoWhileSyntaxContext) {
